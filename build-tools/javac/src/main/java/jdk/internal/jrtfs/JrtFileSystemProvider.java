...
public final class JrtFileSystemProvider extends FileSystemProvider {
  ...
  public FileSystem newFileSystem(URI uri, Map<String, ?> env) throws IOException {
    ...
    this.checkUri(uri);
    return (FileSystem)
        (env.containsKey("java.home")
            ? this.newFileSystem((String) env.get("java.home"), uri, env)
            : new JrtFileSystemWrapper(new JrtFileSystem(this, env)) {});
  }
  ...
  public <A extends BasicFileAttributes> A readAttributes(
    ...
    return type != BasicFileAttributes.class && type != JrtFileAttributes.class
        ? null
        : (A) toJrtPath(path).getAttributes(options);
  }
