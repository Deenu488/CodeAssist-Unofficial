...
public final class SourceFilePosition implements Serializable {
  ...
  @NotNull private final SourceFile mSourceFile;

  @NotNull private final SourcePosition mSourcePosition;

  public SourceFilePosition(
      @NotNull SourceFile sourceFile, @NotNull SourcePosition sourcePosition) {
    mSourceFile = sourceFile;
    mSourcePosition = sourcePosition;
  }

  public SourceFilePosition(@NotNull File file, @NotNull SourcePosition sourcePosition) {
