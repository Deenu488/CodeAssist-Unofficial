...
public class CharSequences {
  ...
  public static int lastIndexOf(@NotNull CharSequence haystack, @NotNull String needle, int start) {
  ...
  public static boolean startsWith(
      @NotNull CharSequence sequence, @NotNull CharSequence prefix, int start) {
  ...
  public static boolean endsWith(
      @NotNull CharSequence sequence, @NotNull CharSequence suffix, boolean caseSensitive) {
  ...
  /**
   * Converts a character to upper case. A slightly optimized version of {@link
  ...
  /**
   * Converts a character to lower case. A slightly optimized version of {@link
  ...
  /**
   * The {@link CharSequenceReader} returned by this method is intended for single-thread use only.
   *
   * @param data the character sequence to read
   * @param stripBom whether a byte order mark at the beginning of the charachter sequence should be
   *     skipped if present
  ...
  /**
   * A {@link CharSequence} intended for use by lint; it is a char[]-backed {@linkplain
   * CharSequence} which can provide its backing array to lint (which is useful to avoid having
   * duplicated data, since for example the ECJ-based backend needs char[] instances of the source
   * files instead of Strings, and the String class always insists on having its own private copy of
   * the char array.
   */
