...
public class SharedPrefsDetector extends Detector implements Detector.JavaScanner {
  ...
  public static final Issue ISSUE =
      Issue.create(
          ...
          6,
          Severity.WARNING,
          new Implementation(SharedPrefsDetector.class, Scope.JAVA_FILE_SCOPE));
  ...
  public void visitMethod(
      ...
      @Nullable JavaVoidVisitor visitor,
    ...
    boolean verifiedType =
        resolved.getReturnType().toString().equals(ANDROID_CONTENT_SHARED_PREFERENCES_EDITOR);
