...
public final class NetworkCodeQualifier extends ResourceQualifier {
  ...
  private static final Pattern sNetworkCodePattern =
      Pattern.compile("^mnc(\\d{1,3})$"); // $NON-NLS-1$
  ...
  /**
   * Returns the folder name segment for the given value. This is equivalent to calling {@link
   * #toString()} on a {@link NetworkCodeQualifier} object.
   *
