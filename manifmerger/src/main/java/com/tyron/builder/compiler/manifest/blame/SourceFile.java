...
public final class SourceFile implements Serializable {
  ...
  @NotNull public static final SourceFile UNKNOWN = new SourceFile();
   ...
   *
   * <p>Usually the file name is OK for the short output, but for the manifest merger, where all of
   * the files will be named AndroidManifest.xml the variant name is more useful.
   */
