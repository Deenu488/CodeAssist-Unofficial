...
public class AndroidManifestParser {
  ...
  private static class ManifestHandler extends DefaultHandler {
    ...
    private void processApplicationNode(Attributes attributes) {
      ...
      value = getAttributeValue(attributes, AndroidManifest.ATTRIBUTE_THEME, true);
      if (value != null) {
  ...
  public static ManifestData parse(String xml)
    ...
    transformer.transform(new DOMSource(document), new SAXResult(manifestHandler));
    return data;
  }
