...
public class MergingException extends Exception {
  ...
  @NotNull private final List<Message> mMessages;
  ...
  public static class Builder {
    ...
    @Nullable private Throwable mCause = null;

    @Nullable private String mMessageText = null;

    @Nullable private String mOriginalMessageText = null;

    @NotNull private SourceFile mFile = SourceFile.UNKNOWN;

    @NotNull private SourcePosition mPosition = SourcePosition.UNKNOWN;
      ...
      if (mCause != null) {
        ...
        if (mPosition == SourcePosition.UNKNOWN && mCause instanceof SAXParseException) {
          ...
          if (lineNumber != -1) {
            ...
            mPosition = new SourcePosition(lineNumber - 1, exception.getColumnNumber() - 1, -1);
          }
        }
      }
  ...
  public String getMessage() {
    ...
    for (Message message : mMessages) {
      ...
      if (sourceFilePositions.size() > 1
          || !sourceFilePositions.get(0).equals(SourceFilePosition.UNKNOWN)) {
