...
public abstract class ResourceQualifier implements Comparable<ResourceQualifier>, Serializable {
   ...
   *
   * <p>null has a special meaning when trying to match the best config (it's the worst qualifier,
   ...
   *
   * <p>Children class that re-implements this must implement {@link #isBetterMatchThan
  ...
  /**
   * Returns true if the receiver (this) is a better match for the given {@code reference} than the
   * given {@code compareTo} comparable.
   *
