...
class ManifestModel {
  ...
  interface NodeKeyResolver {
     ...
     */
    @Nullable
    String getKey(Element xmlElement);
  ...
  /**
   * Implementation of {@link ManifestModel.NodeKeyResolver} that do not provide any key (the
   * element has to be unique in the xml document).
   */
  ...
  /**
   * Implementation of {@link ManifestModel.NodeKeyResolver} that uses an attribute to resolve the
   * key value.
   */
  private static class AttributeBasedNodeKeyResolver implements NodeKeyResolver {
     ...
     */
    private AttributeBasedNodeKeyResolver(
        @Nullable String namespaceUri, @NotNull String attributeName) {
  ...
  /**
   * Subclass of {@link ManifestModel.AttributeBasedNodeKeyResolver} that uses "android:name" as the
   * attribute.
   */
  ...
  /**
   * A {@link ManifestModel.NodeKeyResolver} capable of extracting the element key first in an
   * "android:name" attribute and if not value found there, in the "android:glEsVersion" attribute.
   */
      ...
      new NodeKeyResolver() {
        ...
        private final NodeKeyResolver glEsVersionResolver =
            new AttributeBasedNodeKeyResolver(
                SdkConstants.ANDROID_URI, AndroidManifest.ATTRIBUTE_GLESVERSION);

        @Nullable
        @Override
        public String getKey(Element xmlElement) {
          String key = nameAttrResolver.getKey(xmlElement);
          return Strings.isNullOrEmpty(key) ? glEsVersionResolver.getKey(xmlElement) : key;
        }
  ...
  /**
   * Specific {@link ManifestModel.NodeKeyResolver} for intent-filter elements. Intent filters do
   * not have a proper key, therefore their identity is really carried by the presence of the action
   * and category sub-elements. We concatenate such elements sub-keys (after sorting them to work
   * around declaration order) and use that for the intent-filter unique key.
   */
  private static final NodeKeyResolver INTENT_FILTER_KEY_RESOLVER =
      new NodeKeyResolver() {
        @Nullable
        @Override
  ...
  /**
   * Implementation of {@link ManifestModel.NodeKeyResolver} that combined two attributes values to
  ...
  private static final class TwoAttributesBasedKeyResolver implements NodeKeyResolver {
    ...
    private TwoAttributesBasedKeyResolver(
        NodeKeyResolver firstAttributeKeyResolver, NodeKeyResolver secondAttributeKeyResolver) {
    ...
    public String getKey(Element xmlElement) {
      ...
      return Strings.isNullOrEmpty(firstKey)
          ? secondKey
          : Strings.isNullOrEmpty(secondKey) ? firstKey : firstKey + "+" + secondKey;
    }
    ...
    public ImmutableList<String> getKeyAttributesNames() {
      return ImmutableList.of(
          firstAttributeKeyResolver.getKeyAttributesNames().get(0),
   ...
   *
   * <p>There is no DTD or schema associated with the file type so this is best effort in providing
   ...
   *
   * <ul>
   *   <li>{@link MergeType} to identify how the merging engine should process this element.
   *   <li>{@link ManifestModel.NodeKeyResolver} to resolve the element's key. Elements can have an
   *       attribute like "android:name", others can use a sub-element, and finally some do not have
   *       a key and are meant to be unique.
   ...
   *
   * <p>If you find yourself needing to extend the model to support future requirements, do it here
   * and modify the engine to make proper decision based on the added metadata.
   */
  enum NodeTypes {

    /**
     * Action (contained in intent-filter) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Activity-alias (contained in application) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Category (contained in intent-filter) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Data (contained in intent-filter) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Grant-uri-permission (contained in intent-filter) <br>
     * <b>See also : </b> {@link <a
     ...
     */
    INTENT_FILTER(
        MergeType.ALWAYS, INTENT_FILTER_KEY_RESOLVER, MULTIPLE_DECLARATION_FOR_SAME_KEY_ALLOWED),

    /**
     * Manifest (top level node) <br>
     * <b>See also : </b> {@link <a
     * href=http://developer.android.com/guide/topics/manifest/manifest-element.html>Manifest Xml
     * documentation</a>}
     */
     ...
     * <b>See also : </b> {@link <a
     * href=http://developer.android.com/guide/topics/manifest/meta-data-element.html>Meta-data Xml
     * documentation</a>}
     */
    ...
    /**
     * Permission-group (contained in manifest). <br>
     * <b>See also : </b> {@link <a
    ...
    PERMISSION(
        ...
        AttributeModel.newModel("protectionLevel")
            ...
            .setOnReadValidator(
                new AttributeModel.MultiValueValidator(
                    "normal", "dangerous", "signature", "signatureOrSystem"))),

    /**
     * Permission-tree (contained in manifest). <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Provider (contained in application) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Receiver (contained in application) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Screen (contained in compatible-screens) <br>
     * <b>See also : </b> {@link <a
     * href=http://developer.android.com/guide/topics/manifest/compatible-screens-element.html>
    ...
    /**
     * Supports-gl-texture (contained in manifest) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Support-screens (contained in manifest) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Uses-configuration (contained in manifest) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Uses-feature (contained in manifest) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Use-library (contained in application) <br>
     * <b>See also : </b> {@link <a
     * href=http://developer.android.com/guide/topics/manifest/uses-library-element.html>Use-library
     * Xml documentation</a>}
     */
    USES_LIBRARY(
        MergeType.MERGE,
    ...
    /**
     * Uses-permission (contained in application) <br>
     * <b>See also : </b> {@link <a
    ...
    /**
     * Uses-sdk (contained in manifest) <br>
     * <b>See also : </b> {@link <a
    ...
    USES_SDK(
        ...
        AttributeModel.newModel("maxSdkVersion").setMergingPolicy(AttributeModel.NO_MERGING_POLICY),
