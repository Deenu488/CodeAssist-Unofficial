...
public enum ResourceType {
  ...
  ResourceType(
      @NotNull String name, @NotNull String displayName, @NotNull String... alternateXmlNames) {
    mName = name;
    mKind = Kind.REAL;
  ...
  ResourceType(@NotNull String name, @NotNull String displayName, @NotNull Kind kind) {
    mName = name;
    mKind = kind;
    mDisplayName = displayName;
  ...
  public static ResourceType fromXmlValue(@NotNull String xmlValue) {
    if (xmlValue.equals(SdkConstants.TAG_DECLARE_STYLEABLE) || xmlValue.equals(STYLEABLE.mName)) {
      return null;
    }
