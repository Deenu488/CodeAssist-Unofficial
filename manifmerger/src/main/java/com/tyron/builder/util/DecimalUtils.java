...
public class DecimalUtils {
   ...
   */
  public static String trimInsignificantZeros(
      @NotNull String floatingPointNumber, char decimalSeparator, String exponentialSeparator) {
    ...
    int exponent = CharSequences.indexOfIgnoreCase(floatingPointNumber, exponentialSeparator, pos);
