		...
		switch (gameState) {
			...
			case 1:
				...
				for (int i = 0; i < numberOfTubes; i++) {
					...
					topTubeRectangles[i] = new Rectangle(tubeX[i], topY, topTube.getWidth(), topTube.getHeight());
					bottomTubeRectangles[i] = new Rectangle(tubeX[i], bottomY, bottomTube.getWidth(), bottomTube.getHeight());
				}
