...
public class DrawableManagerAdapter extends RecyclerView.Adapter<DrawableManagerAdapter.ViewHolder> {
    ...
    private static class ItemViewHolder extends ViewHolder {
        ...
        public ItemViewHolder(FrameLayout view) {
            ...
            LayoutInflater.from(view.getContext())
                .inflate(R.layout.drawable_manager_item, view);
            ...
            if (name.endsWith(".png")){
             ...
             File output =new File(icon_cache.getAbsolutePath() , drawables.getRootFile().getName().replace(".xml", ".svg"));
                ...
                System.out.println("Error creating SVG from");
                    ...
                    try {
                        FileInputStream fileInputStream = new FileInputStream(new File(output.getAbsolutePath()));
                        try {
