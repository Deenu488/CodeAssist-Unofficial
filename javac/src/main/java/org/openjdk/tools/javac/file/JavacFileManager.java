...
/**
 * I have modified this a bit to use the custom file system manager because android doesn't provide
 * a ZipFileSystemProvider
 */
...
public class JavacFileManager extends BaseFileManager implements StandardJavaFileManager {
  ...
  private static final JavacFileManager.Container MISSING_CONTAINER =
      new JavacFileManager.Container() {
        public void list(
            Path var1,
            RelativeDirectory var2,
            Set<Kind> var3,
            boolean var4,
            ListBuffer<JavaFileObject> var5)
            throws IOException {}
  ...
  public static char[] toArray(CharBuffer var0) {
    return var0.hasArray()
        ? ((CharBuffer) var0.compact().flip()).array()
        : var0.toString().toCharArray();
  }

  public static void preRegister(Context var0) {
    var0.put(
        JavaFileManager.class,
        (Context.Factory<JavaFileManager>) context -> new JavacFileManager(context, true, null));
  }
  ...
  public JavaFileObject getFileForOutput(String var1, Kind var2, JavaFileObject var3)
      throws IOException {
  ...
  public Iterable<JavaFileObject> list(Location var1, String var2, Set<Kind> var3, boolean var4)
      throws IOException {
    this.checkNotModuleOrientedLocation(var1);
    nullCheck(var2);
    nullCheck(var3);
  ...
  public boolean isSameFile(FileObject var1, FileObject var2) {
    nullCheck(var1);
    nullCheck(var2);
    return var1 instanceof PathFileObject && var2 instanceof PathFileObject
        ? ((PathFileObject) var1).isSameFile((PathFileObject) var2)
        : var1.equals(var2);
  }
  ...
  public JavaFileObject getJavaFileForInput(Location var1, String var2, Kind var3)
      throws IOException {
    this.checkNotModuleOrientedLocation(var1);
    nullCheck(var2);
    nullCheck(var3);
  ...
  public FileObject getFileForInput(Location var1, String var2, String var3) throws IOException {
    ...
    if (!isRelativeUri(var3)) {
      ...
      RelativeFile var4 =
          var2.length() == 0
              ? new RelativeFile(var3)
              : new RelativeFile(RelativeDirectory.forPackage(var2), var3);
  ...
  public JavaFileObject getJavaFileForOutput(Location var1, String var2, Kind var3, FileObject var4)
      throws IOException {
  ...
  public FileObject getFileForOutput(Location var1, String var2, String var3, FileObject var4)
      throws IOException {
    this.checkOutputLocation(var1);
    nullCheck(var2);
    if (!isRelativeUri(var3)) {
  ...
  private JavaFileObject getFileForOutput(Location var1, RelativeFile var2, FileObject var3)
      throws IOException {
    Path var4;
    Path var7;
  ...
  public void setLocationFromPaths(Location var1, Collection<? extends Path> var2)
      throws IOException {
    nullCheck(var1);
  ...
  public <S> ServiceLoader<S> getServiceLoader(Location var1, Class<S> var2) throws IOException {
    ...
    if (var1.isModuleOrientedLocation()) {
      ...
      Configuration var6 =
          var5.configuration()
              .resolveAndBind(ModuleFinder.of(new Path[0]), var4, Collections.emptySet());
  ...
  public void setLocationForModule(Location var1, String var2, Collection<? extends Path> var3)
      throws IOException {
    nullCheck(var1);
    this.checkModuleOrientedOrOutputLocation(var1);
  ...
  private void checkModuleOrientedOrOutputLocation(Location var1) {
    ...
    if (!var1.isModuleOrientedLocation() && !var1.isOutputLocation()) {
      throw new IllegalArgumentException(
          "location is not an output location or a module-oriented location: " + var1.getName());
    }
  }
  ...
  private final class ArchiveContainer implements JavacFileManager.Container {
    ...
    public ArchiveContainer(Path var2)
        throws IOException, ProviderNotFoundException, SecurityException {
      this.archivePath = var2;
      //            if (JavacFileManager.this.multiReleaseValue != null &&
      // var2.toString().endsWith(".jar")) {
      Map<String, String> var3 =
          Collections.singletonMap("multi-release", JavacFileManager.this.multiReleaseValue);
            ...
            new SimpleFileVisitor<Path>() {
              public FileVisitResult preVisitDirectory(Path var1, BasicFileAttributes var2) {
                if (ArchiveContainer.this.isValid(var1.getFileName())) {
                  ArchiveContainer.this.packages.put(
                      new RelativeDirectory(var6.relativize(var1).toString()), var1);
    ...
    public void list(
        ...
        final Set<Kind> var3,
        boolean var4,
        final ListBuffer<JavaFileObject> var5)
        throws IOException {
      ...
      if (var6 != null) {
        ...
        Files.walkFileTree(
            ...
            new SimpleFileVisitor<Path>() {
              public FileVisitResult preVisitDirectory(Path var1, BasicFileAttributes var2) {
                return ArchiveContainer.this.isValid(var1.getFileName())
              ...
              public FileVisitResult visitFile(Path var1, BasicFileAttributes var2) {
                if (var2.isRegularFile() && var3.contains(getKind(var1.getFileName().toString()))) {
                  PathFileObject var3x =
                      PathFileObject.forJarPath(
                          JavacFileManager.this, var1, ArchiveContainer.this.archivePath);
                  var5.append(var3x);
                }
      ...
      if (Files.exists(var6)) {
        if (JavacFileManager.this.caseMapCheck(var6, var2)) {
          ...
          try {
            ...
            try {
              var7 =
                  (JavacFileManager.this.sortFiles == null
                          ? var8
                          : var8.sorted(JavacFileManager.this.sortFiles))
          ...
          for (Path var27 : var7) {
            ...
            if (Files.isDirectory(var27)) {
              ...
              try {
                ...
                PathFileObject var12 =
                    PathFileObject.forDirectoryPath(
                        JavacFileManager.this, var11.resolveAgainst(this.directory), var1, var11);
                var5.append(var12);
      ...
      try {
        ...
        if (Files.exists(var3)) {
          return PathFileObject.forSimplePath(
              JavacFileManager.this, JavacFileManager.this.fsInfo.getCanonicalFile(var3), var3);
        }
  ...
  private final class JRTImageContainer implements JavacFileManager.Container {
    ...
    public void list(
      ...
      try {
        ...
        JavacFileManager.this.log.error(
            "error.reading.file", var1, JavacFileManager.getMessage(var10));
      }
    }
