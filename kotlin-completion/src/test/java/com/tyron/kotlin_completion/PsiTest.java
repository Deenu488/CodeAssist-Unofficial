...
public class PsiTest {
  ...
  public void setup() {
    ...
    mProjectEnvironment.registerProjectExtensionPoint(
        PsiElementFinder.EP_NAME, PsiElementFinder.class);
    CoreApplicationEnvironment.registerApplicationExtensionPoint(
        PsiAugmentProvider.EP_NAME, PsiAugmentProvider.class);
    CoreApplicationEnvironment.registerApplicationExtensionPoint(
        JavaModuleSystem.EP_NAME, JavaModuleSystem.class);
  }
  ...
  public void test() {
    ...
    //        mProjectEnvironment.addJarToClassPath(new
    // File("/home/tyron/AndroidStudioProjects/CodeAssist/build-logic/src/test/resources/bootstraps/rt.jar"));
