...
/**
 * Identifies the range of a code block inside a file or a string. Note that, unlike antlr4 tokens,
 * the line positions start from 0 (to be compatible with Studio).
 *
 * <p>Both start and end line/column indices are inclusive.
 */
...
public class Location {
  ...
  public boolean equals(Object o) {
    ...
    return !(parentLocation != null
        ? !parentLocation.equals(location.parentLocation)
