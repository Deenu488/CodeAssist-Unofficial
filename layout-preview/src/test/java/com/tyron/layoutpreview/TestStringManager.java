...
public class TestStringManager {
  ...
  private final Map<String, Value> DEFAULT =
  ...
  private final Map<String, Value> CH =
      new HashMap<String, Value>() {
        {
  ...
  private final Map<String, Map<String, Value>> VALUES =
  ...
  public void test() {
    ...
    assertThat(value.getAsString()).isEqualTo("TEST_APP");
  }
}
