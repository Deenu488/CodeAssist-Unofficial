...
public class TestLayoutToXml {
  ...
  public void test() throws Exception {
    ...
    Value read =
        new ProteusTypeAdapterFactory(context)
    ...
    String expected =
        XmlPrettyPrinter.prettyPrint(
            TEST_LAYOUT, XmlFormatPreferences.defaults(), XmlFormatStyle.LAYOUT, "\n");
    String result =
        XmlPrettyPrinter.prettyPrint(
            convert, XmlFormatPreferences.defaults(), XmlFormatStyle.LAYOUT, "\n");
