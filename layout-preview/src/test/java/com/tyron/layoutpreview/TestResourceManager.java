...
public class TestResourceManager {
  ...
  public static final String STYLE_XML =
      "<resources>\n"
          ...
          + "    </style>\n"
          + "</resources>\n";
  public static final String COLOR_XML =
      "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
          ...
          + "</resources>";
  public static final String STYLEABLE_XML =
      "<resources>\n"
          + "\n"
  ...
  public void test() throws IOException, XmlPullParserException {
    ResourceStringParser parser = new ResourceStringParser(null, new MockFileManager(null));
