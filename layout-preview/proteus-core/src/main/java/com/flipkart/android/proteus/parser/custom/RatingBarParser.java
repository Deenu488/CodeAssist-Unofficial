...
public class RatingBarParser<T extends FixedRatingBar> extends ViewTypeParser<T> {
  ...
  protected void addAttributeProcessors() {
    ...
    addAttributeProcessor(
        Attributes.RatingBar.IsIndicator,
    ...
    addAttributeProcessor(
        Attributes.RatingBar.MinHeight,
    ...
    addAttributeProcessor(
        Attributes.RatingBar.ProgressDrawable,
