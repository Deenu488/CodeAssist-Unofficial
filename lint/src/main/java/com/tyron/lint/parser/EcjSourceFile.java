...
public class EcjSourceFile extends CompilationUnit {
  ...
  public EcjSourceFile(@NonNull char[] source, @NonNull File file, @NonNull String encoding) {
    super(source, file.getPath(), encoding);
    mSource = new String(source);
  }

  public EcjSourceFile(@NonNull String source, @NonNull File file, @NonNull String encoding) {
