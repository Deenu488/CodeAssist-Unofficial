...
public abstract class LintClient {
  ...
  /**
   * Returns an optimal detector, if applicable. By default, just returns the original detector, but
   * tools can replace detectors using this hook with a version that takes advantage of native
  ...
  /**
   * Report the given issue. This method will only be called if the configuration has reported the
   * corresponding issue as enabled and has not filtered out the issue with its {@link
