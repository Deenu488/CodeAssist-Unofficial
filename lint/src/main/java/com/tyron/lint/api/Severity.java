...
public enum Severity {
  /**
   * Fatal: Use sparingly because a warning marked as fatal will be considered critical and will
   * abort Export APK etc in ADT
   */
  @NonNull
  FATAL("Fatal"),
  ...
  @NonNull private final String mDisplay;
